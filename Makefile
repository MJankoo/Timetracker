...
install:
	...
	docker exec -it innovation_software_mysql /usr/bin/mysql -u root --password=root -e "CREATE DATABASE IF NOT EXISTS symfony CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;"
	docker exec -it innovation_software_php /bin/bash -c "composer install --working-dir=/var/www/symfony/app/"
	docker exec -it innovation_software_php /bin/bash -c "/var/www/symfony/app/bin/console doctrine:migrations:migrate"
